...
class FloatCodec : Codec<Float>() {
  override fun encode(buffer: ProtocolBuffer, value: Float) {
    buffer.data.writeFloat(value)
  }

  override fun decode(buffer: ProtocolBuffer): Float {
    return buffer.data.readFloat()
  }
}
