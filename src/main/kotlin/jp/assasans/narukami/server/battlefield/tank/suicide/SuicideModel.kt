...
@ProtocolEvent(6374471164629053857)
data class SuicideModelSuicideEvent(
  val respawnDelayMS: Int,
) : IClientEvent

@ProtocolEvent(1804405396221295630)
class SuicideModelSuicideRequestEvent : IServerEvent
