...
@ProtocolModel(1237976996871886061)
data class WeaponCommonModelCC(
  val buffShotCooldownMs: Int,
  val buffed: Boolean,
  val highlightingDistance: Float,
  val impactForce: Float,
  val kickback: Float,
  val turretRotationAcceleration: Float,
  val turretRotationSound: Resource<SoundRes, Eager>,
  val turretRotationSpeed: Float,
) : IModelConstructor
