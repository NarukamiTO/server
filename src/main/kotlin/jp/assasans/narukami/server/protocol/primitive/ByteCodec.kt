...
class ByteCodec : Codec<Byte>() {
  override fun encode(buffer: ProtocolBuffer, value: Byte) {
    buffer.data.writeByte(value.toInt())
  }

  override fun decode(buffer: ProtocolBuffer): Byte {
    return buffer.data.readByte()
  }
}
