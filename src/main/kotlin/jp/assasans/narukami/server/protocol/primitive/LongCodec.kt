...
class LongCodec : Codec<Long>() {
  override fun encode(buffer: ProtocolBuffer, value: Long) {
    buffer.data.writeLong(value)
  }

  override fun decode(buffer: ProtocolBuffer): Long {
    return buffer.data.readLong()
  }
}
