...
class ShortCodec : Codec<Short>() {
  override fun encode(buffer: ProtocolBuffer, value: Short) {
    buffer.data.writeShort(value.toInt())
  }

  override fun decode(buffer: ProtocolBuffer): Short {
    return buffer.data.readShort()
  }
}
