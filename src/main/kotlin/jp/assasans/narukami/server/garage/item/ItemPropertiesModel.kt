...
@ProtocolModel(4245000165576407500)
data class ItemPropertiesModelCC(
  /**
   * Client can display up to 9 properties correctly.
   */
  val properties: List<ItemGaragePropertyData>,
) : IModelConstructor

@ProtocolStruct
data class ItemGaragePropertyData(
