...
class AraumiProcessor(
  ...
  override fun process(resolver: Resolver): List<KSAnnotated> {
    val symbols = resolver
      .getSymbolsWithAnnotation("org.araumi.server.net.command.ProtocolClass")
    ...
    // build/generated/ksp/main/kotlin/org/araumi/server/derive/GeneratedFunctions.kt
    val file = codeGenerator.createNewFile(
      // Make sure to associate the generated file with sources to keep/maintain it across incremental builds.
      // Learn more about incremental processing in KSP from the official docs:
      // https://kotlinlang.org/docs/ksp-incremental.html
      dependencies = Dependencies(false, *resolver.getAllFiles().toList().toTypedArray()),
      packageName = "org.araumi.server.derive",
    ...
    file.use {
      ...
      file += "package org.araumi.server.derive\n"
      file += "import kotlin.reflect.KClass\n"
      file += "import kotlin.reflect.KProperty1\n"
      file += "val templateToModels: Map<KClass<out org.araumi.server.core.ITemplate>, Map<KProperty1<out org.araumi.server.core.ITemplate, *>, KClass<out org.araumi.server.core.IModelConstructor>>> = mapOf(\n"
  ...
  inner class Visitor(private val file: OutputStream) : KSVisitorVoid() {
    ...
    override fun visitValueParameter(valueParameter: KSValueParameter, data: Unit) {
      ...
      if(!typeName.equals("org.araumi.server.core.IModelProvider")) {
